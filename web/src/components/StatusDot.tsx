...
export const STATE_META: Record<RunState, { label: string; dot: string; text: string }> = {
  ...
  CONFIRMED: { label: "Confirmed", dot: "bg-[color:var(--cq-iris)] animate-pulse", text: "text-[color:var(--cq-iris)]" },
  IN_EXECUTION: { label: "In execution", dot: "bg-green-500 animate-pulse", text: "text-green-600 font-bold" },
  ...
  BLOCKED: { label: "Blocked", dot: "bg-red-600 animate-pulse", text: "text-red-700 font-bold" },
